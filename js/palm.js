...
Oppai.Palm = function(center, isRight) {
  this.unit = 1.5;
  ...
  var isRight = center.z < 0 ? -1 : 1;
  this.palm1.position.set(0, 1, 0);
  this.palm2.position.set(-this.unit/3, -this.unit*2, this.unit/3 * isRight);
  this.palm2.rotation.z = -Math.PI / 180 * 30;
  this.finger0.position.set(-this.unit, this.unit, -this.unit*4 * isRight);
  this.finger0.rotation.x = -Math.PI / 180 * 30 * isRight;
  this.finger0.rotation.z = Math.PI / 180 * 30;
  this.finger1.position.set(-this.unit*4/3, this.unit*14/3+this.unit/15, -this.unit*7/3 * isRight);
  this.finger1.rotation.x = -Math.PI / 180 * 10 * isRight;
  this.finger1.rotation.z = Math.PI / 180 * 30;
  this.finger2.position.set(-this.unit*4/3, this.unit*15/3+this.unit/15, -this.unit*12/15 * isRight);
  this.finger2.rotation.x = -Math.PI / 180 * 3 * isRight;
  this.finger2.rotation.z = Math.PI / 180 * 30;
  this.finger3.position.set(-this.unit*4/3, 4.1+6.5/2, (1+0.2) * isRight);
  this.finger3.rotation.x = Math.PI / 180 * 3 * isRight;
  this.finger3.rotation.z = Math.PI / 180 * 30;
  this.finger4.position.set(-this.unit*4/3, 4.1+5/2, (3+0.5) * isRight);
  this.finger4.rotation.x = Math.PI / 180 * 10 * isRight;
  this.finger4.rotation.z = Math.PI / 180 * 30;
